  ...
  return (
    <div className="info-container">
      <div className="FAQ-container">
        <h1>What is Onstream?</h1>
        <div className="img-div"></div>
        <div className="para-div">
          <p>
            Onstream is a subscription-based streaming service that allows our
            members to watch TV shows and movies without commercials on an
            internet-connected device.
          </p>
          <p>
            You can also download TV shows and movies to your iOS, Android, or
          ...
          <p>
            ...
            Onstream, visit Getting started with Onstream.
          </p>
        </div>
      </div>
    </div>
